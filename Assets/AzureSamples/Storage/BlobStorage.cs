...
public class BlobStorage : BaseStorage
{
	...
	public async void BlobStorageTest()
	{
        ...
        //await BasicStoragePageBlobOperationsAsync(); // HERE
	}
	...
	private async Task BasicStorageBlockBlobOperationsAsync()
	{
        ...
        // Get Container
		CloudBlobContainer container = blobClient.GetContainerReference("others"); // HERE
        ...
        // Upload a BlockBlob to the newly created container // Arquivo com mesmo nome, é atualizado
        WriteLine("2. Uploading BlockBlob");
        // Path no container + nome do arquivo que sera salvo
...
#else
        // Edita arquivo de txt
        //File.WriteAllText(Path.Combine(Application.streamingAssetsPath, "password.txt"), "741"); 
